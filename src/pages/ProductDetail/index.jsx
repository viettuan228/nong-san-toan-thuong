                    ...
                    <div className="flex w-[540px] flex-col gap-4">
                        ...
                        <div className="text-base flex flex-col gap-4">
                            <p>
                                ...
                                enriched with the flavor and nutrients of free
                                range eggs. This tagliatelle is long, somewhat
                                wide, and high in protein compared to other
                                types of pasta. Tagliatelle pasta is
                                particularly well-paired with rich, creamy
                                sauces.
                            </p>
                            <p>
                                Rigatoni pasta is one of the most popular types
                                of pasta. However, La Fabbrica Della Pasta is
                                not like every other pasta brand! La Fabbrica
                                uses traditional Italian techniques along with
                                natural spring water from Mount Vesuvius.
                            </p>
                        </div>
